...
# Follow this guide for other UNIX distrib : https://github.com/OpenSC/OpenSC/wiki/Compiling-and-Installing-on-Unix-flavors

# Install libp11
# sudo pacman -S libp11
# For osslsigncode on archlinux:
# Use this AUR package https://aur.archlinux.org/packages/osslsigncode
# It should also install everything about pkcs11
